...
public class  CountTimeView extends View {
    ...
    public CountTimeView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        isCountUp = ta.getBoolean(R.styleable.CountdownView_isCountUp, true);
            ...
            mCustomCountUpTimer = new CustomCountUpTimer(millisecond, countDownInterval) {
                ...
                public void onFinish() {
                    ...
                    if (null != mOnCountdownEndListener) {
                        mOnCountdownEndListener.onEnd(CountTimeView.this);
                    }
                }
            };
    ...
    public interface OnCountdownEndListener {
        void onEnd(CountTimeView cv);
    }

    public interface OnCountdownIntervalListener {
        void onInterval(CountTimeView cv, long remainTime);
    }
