package com.delta.commonlibs.imageloader.glide;
...
import com.delta.commonlibs.http.OkHttpUrlLoader;
import com.delta.commonlibs.utils.DataHelper;
    ...
    public void applyOptions(final Context context, GlideBuilder builder) {
        builder.setDiskCache(new DiskCache.Factory() {
            ...
            public DiskCache build() {
                ...
                BaseAppComponent appComponent = ((BaseCommonApplication) context.getApplicationContext()).getAppComponent();
